...
type BatchGetProfileRsp struct {
	...
	FailedUIDs []uint64    `protobuf:"varint,2,rep,packed,name=failedUIDs,proto3" json:"failedUIDs,omitempty"`
}
...
func (x *BatchGetProfileRsp) GetFailedUIDs() []uint64 {
	if x != nil {
		return x.FailedUIDs
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x04, 0x52, 0x0a, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x55, 0x49, 0x44, 0x73, 0x22,
